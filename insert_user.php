...
function DetailsInsert($con)
{
	...
	$query="INSERT INTO `happy_hearts`.`user` ( `first_name`, `last_name`, `pwd`, `contact_no`, `email`) VALUES ('".$_POST["first_name"]."','".$_POST["last_name"]."','".$_POST["password"]."','".$_POST["contact_no"]."','".$_POST["email_id"]."');"; //id is auto increment
