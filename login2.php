...
function validateForm() {
    ...
    if( document.myForm.password.value == "" )
         {
            alert( "Please enter atmost 10 characters" );
		...
		<div id="page-wrapper">
				<div id="header">
						...
						<nav id="nav">
							<ul>
								...
								<li class="current"><a href="login2.html">Login</a></li>
				...
				<div ><!-- form2 --></br>
					<form style="margin: 0 auto; width:20%" name="myForm" action="demo_form.asp" onsubmit="return (validateForm());" method="post">
						<h1>Login!</h1></br>
						Username:<br> <input type="text" name="username" placeholder="username" required ></input><br>
						Password(10 characters max):<br> <input type="password" name="password"  length="10" required ></input><br>
