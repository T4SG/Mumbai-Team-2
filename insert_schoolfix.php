...
$datecon=$_POST["YYYY"]."-".$_POST["MM"]."-".$_POST["DD"];
	...
	$query="INSERT INTO `happy_hearts`.`school_fixtures` ( `school_id`, `date_detected`, `area`, `description`,`cost_repair`) VALUES ('".$_POST["school_id"]."','".$datecon."','".$_POST["area"]."','".$_POST["description"]."','".$_POST["est_cost"]."');"; //id is auto increment
